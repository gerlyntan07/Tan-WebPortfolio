...
function App() {
  ...
  const structuredData = {
    ...
    description:
      "Portfolio of a front-end developer and UI designer specializing in React.js.",
  };

  return (
    <main
      className={`${darkMode ? "bg-darkBackground" : "bg-lightBG"} ${showFolder ? "overflow-hidden h-screen" : ""} m-0 p-0`}
    >
      <Helmet>
        <script
        ...
        <meta
          property="og:image"
          content="https://tan-web-portfolio.vercel.app/src/assets/portfolio-logo.png"
        />
        <meta
          property="og:url"
          content="https://tan-web-portfolio.vercel.app/"
        />
        <meta property="og:title" content="Gerlyn Tan | Front-End Developer" />
        <meta
          property="og:description"
          content="Portfolio of a skilled Front-End Developer and UI Designer with expertise in React.js."
        />
      </Helmet>
